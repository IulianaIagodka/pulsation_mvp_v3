...
2. Reopening the app after the threshold navigates to `/trigger` (not during action / return), if eligibility passes (cooldown, dismissal dampening, etc.; daily cap temporarily off).
