...
When Pulsation is in the background, it schedules a short series of local **one-action invitations** from time to time at a **dynamic interval** near 20 minutes (each gap kept in a 10-30 minute window and adapted by recent completions, ignores, and absence — see `docs/adaptive-scheduling.md`):
