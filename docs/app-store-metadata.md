...
Як це працює
Після онбордингу застосунок запрошує до однієї м'якої дії. Він тихо обирає одну з трьох опцій з урахуванням нещодавнього досвіду в застосунку (лише на пристрої). Інші додатки не читаються й не аналізуються.
