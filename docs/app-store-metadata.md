...
How it works
After onboarding, the app invites you to one gentle action. It quietly chooses among three options based on your recent in-app use (stored only on your device). Pulsation does not read or analyze your other apps.
...
Як це працює
Після онбордингу застосунок запрошує до однієї м'якої дії. Він тихо обирає одну з трьох опцій з урахуванням недавнього досвіду в застосунку (лише на пристрої). Інші додатки не читаються й не аналізуються.
