...
- **Latest submitted:** **1.0.8** build **48** uploaded to App Store Connect; Apple processing/TestFlight availability follows.
...
| TestFlight не бачить build | Перевір, що build прив’язаний до версії **1.0.8** |
