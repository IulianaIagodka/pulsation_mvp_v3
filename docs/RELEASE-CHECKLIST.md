...
**iPad:** якщо Connect вимагає **13-inch iPad** — готові PNG у `docs/app-store-screenshots/ipad-13-inch/` (**2064×2752**). Запас: `ipad-12.9-inch/` (**2048×2732**). У проєкті зараз **`supportsTablet: false`** — після **нового** build iPad-скріни можуть не знадобитися.
