...
3. [ ] **Action** — одна з дій (feet / find 3 / triangle breath; spiral виглядає однаково)
4. [ ] **Return** — «Ти тут» + відкладене текстове пояснення (окремого екрана explanation немає)
